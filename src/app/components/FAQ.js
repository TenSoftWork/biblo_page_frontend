...
const FAQ = () => {
  ...
  const faqs = [
    {
      question: "Biblo는 기존 도서관 검색 시스템과 무엇이 다른가요?",
      answer:
        "Biblo는 책 단위가 아닌, 작품(Work) 단위로 콘텐츠를 인식합니다. 예를 들어, 원문, 번역본, 해설판 등 다양한 버전이 하나로 통합되어 검색됩니다. 사용자는 단순히 제목만 입력해도 관련 자료를 모두 한 눈에 확인할 수 있습니다.",
    },
    {
      question: "Biblo에서 'Work 단위 검색'이란 무엇인가요?",
      answer:
        "하나의 작품이 여러 언어, 형식, 해설 등으로 출판되더라도 Biblo는 이를 의미적으로 같은 콘텐츠로 인식하고 묶어 보여줍니다. 결과적으로 흩어진 자료를 하나의 흐름으로 탐색할 수 있습니다.",
    },
    {
      question: "Biblo는 어떤 데이터를 수집하고 활용하나요?",
      answer:
        "사용자의 검색 기록, 하이라이트, 스크랩, 노트 등을 기반으로 개인화된 학습 및 연구 지원 데이터를 생성합니다. 수집된 데이터는 대학 내 서버에 저장되며 외부로 유출되지 않습니다.",
    },
    {
      question: "Biblo는 연구자에게 어떤 도움을 주나요?",
      answer:
        "연구 주제에 맞는 자료 추천, 논문 요약, 유사 연구 연결, 맞춤형 연구 보고서 생성 등 다양한 AI 기반 기능을 제공합니다. 또한 연구 흐름을 분석하여 개인 맞춤 연구 전략을 제안합니다.",
    },
    {
      question: "Biblo는 대학 외 기관에서도 사용할 수 있나요?",
      answer:
        "예, 가능합니다. 연구소, 공공기관, 아카이브 등 다양한 지식기관에서 기관 맞춤형 AI 검색 시스템으로 활용될 수 있습니다.",
    },
    {
      question: "Biblo는 어떻게 구축되고 유지되나요?",
      answer:
        "Biblo는 기관 서버 또는 클라우드에 설치됩니다. 기존 도서관 데이터와 연동하여 검색 AI가 훈련되며 지속적으로 자동 업데이트 및 검색 품질 향상이 이루어집니다.",
    },
    {
      question: "기존 도서관 시스템과 Biblo를 연동할 수 있나요?",
      answer:
        "예, 가능합니다. MARC, KORMARC, RDF 등 서지포맷을 지원하며 OPAC 또는 LMS 시스템과 API 방식으로 쉽게 연동할 수 있습니다. 기존 시스템을 그대로 유지하면서 Biblo를 추가로 사용할 수 있습니다.",
    },
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10 md:mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-6xl font-medium mb-4 md:mb-6">
            ...
            <span className="text-[#6A71A8]">Questions</span>
            <br />
            <span className="text-[#6A71A8]">About Rescale</span>
          </h2>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 p-6 md:p-8 mt-12 md:mt-20">
          ...
          <AnimatedButton href="/contact#top">Get Assistance</AnimatedButton>
        </div>
      </div>
    </section>
  );
